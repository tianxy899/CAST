...
import cress.datasets.speech_and_text_translation_dataset_d2s_gate_infer as gate
...
class SpeechToTextTaskModified(LegacyFairseqTask):
    ...
    def __init__(self, args, tgt_dict):
        ...
        if getattr(args, "doc_mode", False) is True:
            self.SpeechToTextDataset = gate.SpeechAndTextTranslationDataset
            self.SpeechToTextDatasetCreator = gate.SpeechAndTextTranslationDatasetCreator
        else:
            self.SpeechToTextDataset = SpeechToTextDataset
            self.SpeechToTextDatasetCreator = SpeechToTextDatasetCreator
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = self.SpeechToTextDatasetCreator.from_tsv(
            self.args.data,
            self.data_cfg,
            split,
            self.tgt_dict,
    ...
    def build_generator(
        ...
        lang_token_ids = {
            ...
            if self.SpeechToTextDataset.is_lang_tag(s)
        }
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, **kwargs):
        return self.SpeechToTextDataset(
